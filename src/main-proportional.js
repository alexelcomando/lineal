/**
 * VERSIÓN CON PROPORCIÓN CORRECTA - Espacio Fijo para Imágenes
 * Editor Inteligente de Imágenes - Álgebra Lineal
 */

console.log('Cargando editor de imágenes con proporción correcta...');
...
function setupCanvasSpace(canvasId) {
    ...
    // Establecer tamaño fijo del espacio
    ...
    // Agregar borde para visualizar el espacio
    ctx.strokeStyle = '#ddd';
    ctx.lineWidth = 2;
...
function drawImageInSpace(imageData, canvasId, clearFirst = true) {
    ...
    // Dibujar imagen en el espacio manteniendo proporción
    ctx.save();
    ctx.drawImage(
        tempCanvas, 
        fit.offsetX, 
...
// ==========================================
// FUNCIONES DE TRANSFORMACIÓN (AHORA CON PROPORCIÓN)
// ==========================================
...
async function handleFileUpload(event) {
    ...
    try {
        ...
        // Configurar espacios de canvas
        setupCanvasSpace('originalCanvas');
        setupCanvasSpace('transformedCanvas');
        
        // Dibujar imágenes manteniendo proporción
...
// ==========================================
// FUNCIONES PRINCIPALES (CON PROPORCIÓN CORRECTA)
// ==========================================
function loadSampleImage() {
    try {
        console.log('Cargando imagen de ejemplo...');
        
        // Crear imagen de ejemplo con tamaño variable para probar proporción
...
// ==========================================
function startApp() {
    console.log('Iniciando aplicación con proporción correcta...');
    ...
    console.log('Aplicación con proporción correcta iniciada');
}
...
console.log('Script con proporción correcta cargado');
